    ...
    def generate(self, event, lap_percent, role, tone, other_info=""):
        ...
        image_msg = {
            ...
            "content": [
                {
                    "type": "text",
                    "text": "This is a screenshot of the current view. Use " \
                        "this to provide context for the commentary. If " \
                        "the image is not helpful, you can ignore it. Keep " \
                        "in mind that the audience does not know that this " \
                        "commentary is being generated by a computer, so " \
                        "do not reference the image in your commentary."
                },
                {
                    "type": "image_url",
                    "image_url": {
