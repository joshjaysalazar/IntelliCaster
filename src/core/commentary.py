...
class Commentary:
    ...
    def __init__(self, settings, context, ir, add_message):
        ...
        Args:
            ...
            add_message (function): The function to call to add a message to
                the message box.
        ...
        self.text_generator = TextGenerator(self.settings, self.context)
